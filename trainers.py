...
class AUCTrainer(Trainer):
    def __init__(self, *args, p=1 / (1 + 0.2), lambda_reg=0, lr_2=0.5, loss="AUC", **kwargs):
        ...
        self.AUC_optim = None # "adamw_minimax"
        self.loss = loss
        self.learning_rate_2 = lr_2
    ...
    def create_optimizer(self):
        ...
        """
        print('create optimizer for AUC maximization')
        opt_model = self.model_wrapped if is_sagemaker_mp_enabled() else self.model

        if self.optimizer is None:
            print('self optimizer is none')
